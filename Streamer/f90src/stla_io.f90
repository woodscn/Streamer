...
!
  ...
  character ( len = 256 ) word1
  character ( len = 256 ) word2
!f2py intent(in) :: input_file_name
!f2py intent(in) :: node_num
!f2py intent(in) :: face_num
!f2py intent(out) :: node_xyz
!f2py intent(out) :: face_node
!f2py intent(out) :: face_normal
