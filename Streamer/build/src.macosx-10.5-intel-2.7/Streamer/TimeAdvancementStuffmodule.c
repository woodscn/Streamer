...
/***************************** computationalgrads *****************************/
static char doc_f2py_rout_TimeAdvancementStuff_timeadvancementstuff_computationalgrads[] = "\
Function signature:\n\
...
/*  */
static PyObject *f2py_rout_TimeAdvancementStuff_timeadvancementstuff_computationalgrads(const PyObject *capi_self,
                           PyObject *capi_args,
                           PyObject *capi_keywds,
...
#endif
  if (!PyArg_ParseTupleAndKeywords(capi_args,capi_keywds,\
    "OO:TimeAdvancementStuff.timeadvancementstuff.computationalgrads",\
...
/*frompyobj*/
  ...
  if (capi_metric_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(TimeAdvancementStuff_error,"failed in converting 1st argument `metric' of TimeAdvancementStuff.timeadvancementstuff.computationalgrads to C/Fortran array" );
  } else {
  ...
  if (capi_gradeta_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(TimeAdvancementStuff_error,"failed in converting hidden `gradeta' of TimeAdvancementStuff.timeadvancementstuff.computationalgrads to C/Fortran array" );
  } else {
    gradeta = (double *)(capi_gradeta_tmp->data);

  /* Processing variable jac */
    f2py_success = double_from_pyobj(&jac,jac_capi,"TimeAdvancementStuff.timeadvancementstuff.computationalgrads() 2nd argument (jac) can't be converted to double");
  if (f2py_success) {
  ...
  if (capi_gradzeta_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(TimeAdvancementStuff_error,"failed in converting hidden `gradzeta' of TimeAdvancementStuff.timeadvancementstuff.computationalgrads to C/Fortran array" );
  } else {
  ...
  if (capi_gradxi_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(TimeAdvancementStuff_error,"failed in converting hidden `gradxi' of TimeAdvancementStuff.timeadvancementstuff.computationalgrads to C/Fortran array" );
  } else {
...
Function signature:\n\
  out = createcolumn(main_data,bc_state,[nx,ny])\n\
Required arguments:\n"
"  main_data : input rank-3 array('d') with bounds (21,nx,ny)\n"
"  bc_state : input rank-3 array('d') with bounds (21,nx,ny)\n"
"Optional arguments:\n"
...
/*frompyobj*/
  ...
  /* Processing variable nx */
  if (nx_capi == Py_None) nx = shape(main_data,1); else
    f2py_success = int_from_pyobj(&nx,nx_capi,"TimeAdvancementStuff.timeadvancementstuff.createcolumn() 1st keyword (nx) can't be converted to int");
  if (f2py_success) {
  CHECKSCALAR(shape(main_data,1)==nx,"shape(main_data,1)==nx","1st keyword nx","createcolumn:nx=%d",nx) {
  /* Processing variable ny */
  if (ny_capi == Py_None) ny = shape(main_data,2); else
    f2py_success = int_from_pyobj(&ny,ny_capi,"TimeAdvancementStuff.timeadvancementstuff.createcolumn() 2nd keyword (ny) can't be converted to int");
  if (f2py_success) {
  CHECKSCALAR(shape(main_data,2)==ny,"shape(main_data,2)==ny","2nd keyword ny","createcolumn:ny=%d",ny) {
...
#endif
/*callfortranroutine*/
        (*f2py_func)(main_data,bc_state,&nx,&ny,out);
if (PyErr_Occurred())
  f2py_success = 0;
#ifdef F2PY_REPORT_ATEXIT
f2py_stop_call_clock();
...
/********************************** jacobian **********************************/
static char doc_f2py_rout_TimeAdvancementStuff_timeadvancementstuff_jacobian[] = "\
Function signature:\n\
...
"  jacobian : float";
/* #declfortranroutine# */
static PyObject *f2py_rout_TimeAdvancementStuff_timeadvancementstuff_jacobian(const PyObject *capi_self,
                           PyObject *capi_args,
                           PyObject *capi_keywds,
...
#endif
  if (!PyArg_ParseTupleAndKeywords(capi_args,capi_keywds,\
    "O:TimeAdvancementStuff.timeadvancementstuff.jacobian",\
    capi_kwlist,&in_capi))
    return NULL;
/*frompyobj*/
  ...
  if (capi_in_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(TimeAdvancementStuff_error,"failed in converting 1st argument `in' of TimeAdvancementStuff.timeadvancementstuff.jacobian to C/Fortran array" );
  } else {
...
/******************************** twodgradient ********************************/
static char doc_f2py_rout_TimeAdvancementStuff_timeadvancementstuff_twodgradient[] = "\
Function signature:\n\
...
/*  */
static PyObject *f2py_rout_TimeAdvancementStuff_timeadvancementstuff_twodgradient(const PyObject *capi_self,
                           PyObject *capi_args,
                           PyObject *capi_keywds,
...
#endif
  if (!PyArg_ParseTupleAndKeywords(capi_args,capi_keywds,\
    "OOO|OO:TimeAdvancementStuff.timeadvancementstuff.twodgradient",\
    capi_kwlist,&in_capi,&dx_capi,&dy_capi,&nx_capi,&ny_capi))
    return NULL;
/*frompyobj*/
  /* Processing variable dx */
    f2py_success = double_from_pyobj(&dx,dx_capi,"TimeAdvancementStuff.timeadvancementstuff.twodgradient() 2nd argument (dx) can't be converted to double");
  if (f2py_success) {
  /* Processing variable in */
  ;
  capi_in_intent |= F2PY_INTENT_IN;
  ...
  if (capi_in_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(TimeAdvancementStuff_error,"failed in converting 1st argument `in' of TimeAdvancementStuff.timeadvancementstuff.twodgradient to C/Fortran array" );
  } else {
    in = (double *)(capi_in_tmp->data);

  /* Processing variable dy */
    f2py_success = double_from_pyobj(&dy,dy_capi,"TimeAdvancementStuff.timeadvancementstuff.twodgradient() 3rd argument (dy) can't be converted to double");
  if (f2py_success) {
  /* Processing variable nx */
  if (nx_capi == Py_None) nx = shape(in,0); else
    f2py_success = int_from_pyobj(&nx,nx_capi,"TimeAdvancementStuff.timeadvancementstuff.twodgradient() 1st keyword (nx) can't be converted to int");
  if (f2py_success) {
  CHECKSCALAR(shape(in,0)==nx,"shape(in,0)==nx","1st keyword nx","twodgradient:nx=%d",nx) {
  /* Processing variable ny */
  if (ny_capi == Py_None) ny = shape(in,1); else
    f2py_success = int_from_pyobj(&ny,ny_capi,"TimeAdvancementStuff.timeadvancementstuff.twodgradient() 2nd keyword (ny) can't be converted to int");
  if (f2py_success) {
  ...
  if (capi_grady_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(TimeAdvancementStuff_error,"failed in converting hidden `grady' of TimeAdvancementStuff.timeadvancementstuff.twodgradient to C/Fortran array" );
  } else {
  ...
  if (capi_gradx_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(TimeAdvancementStuff_error,"failed in converting hidden `gradx' of TimeAdvancementStuff.timeadvancementstuff.twodgradient to C/Fortran array" );
  } else {
...
static FortranDataDef f2py_timeadvancementstuff_def[] = {
  ...
  {"computationalgrads",-1,{{-1}},0,NULL,(void *)f2py_rout_TimeAdvancementStuff_timeadvancementstuff_computationalgrads,doc_f2py_rout_TimeAdvancementStuff_timeadvancementstuff_computationalgrads},
  ...
  {"jacobian",-1,{{-1}},0,NULL,(void *)f2py_rout_TimeAdvancementStuff_timeadvancementstuff_jacobian,doc_f2py_rout_TimeAdvancementStuff_timeadvancementstuff_jacobian},
  {"twodgradient",-1,{{-1}},0,NULL,(void *)f2py_rout_TimeAdvancementStuff_timeadvancementstuff_twodgradient,doc_f2py_rout_TimeAdvancementStuff_timeadvancementstuff_twodgradient},
  {NULL}
};

static void f2py_setup_timeadvancementstuff(char *checkcreatecolumn,char *computationalgrads,char *createcolumn,char *jacobian,char *twodgradient) {
  int i_f2py=0;
  f2py_timeadvancementstuff_def[i_f2py++].data = checkcreatecolumn;
  f2py_timeadvancementstuff_def[i_f2py++].data = computationalgrads;
  f2py_timeadvancementstuff_def[i_f2py++].data = createcolumn;
  f2py_timeadvancementstuff_def[i_f2py++].data = jacobian;
  f2py_timeadvancementstuff_def[i_f2py++].data = twodgradient;
}
extern void F_FUNC(f2pyinittimeadvancementstuff,F2PYINITTIMEADVANCEMENTSTUFF)(void (*)(char *,char *,char *,char *,char *));
...
"Fortran 90/95 modules:\n""  timeadvancementstuff --- checkcreatecolumn(),computationalgrads(),createcolumn(),jacobian(),twodgradient()"".");
